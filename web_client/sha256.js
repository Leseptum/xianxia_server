// Pure-JS SHA-256 (FIPS 180-4), used instead of `crypto.subtle.digest` because
// the Web Crypto API is only available in secure contexts (https, or
// localhost/127.0.0.1) - this client is also meant to be opened via a plain
// http:// LAN IP (see README), where crypto.subtle is undefined.
const SHA256_K = [
