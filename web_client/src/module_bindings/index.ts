...
const tablesSchema = __schema({
  editorSession: __table({
    name: 'editor_session',
    indexes: [
      { accessor: 'Owner', name: 'editor_session_owner_idx_btree', algorithm: 'btree', columns: [
        'owner',
      ] },
    ],
    constraints: [
      { name: 'editor_session_owner_key', constraint: 'unique', columns: ['owner'] },
    ],
  }, EditorSessionRow),
  loginAttempt: __table({
    name: 'login_attempt',
    indexes: [
      { accessor: 'PlayerId', name: 'login_attempt_player_id_idx_btree', algorithm: 'btree', columns: [
        'playerId',
      ] },
    ],
    constraints: [
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `editorSession` instead. This alias will be removed in the next major version. */
    ...
    readonly "WorldTile": Omit<typeof tablesSchema.schemaType.tables["worldTile"], "accessorName"> & { readonly accessorName: "WorldTile" };
  };
};
...
export type DbView = __DbViewBase & {
  ...
  /** @deprecated Use `worldTile` instead. This alias will be removed in the next major version. */
  readonly "WorldTile": __DbViewBase["worldTile"];
};
...
export type Tables = __TablesBase & {
  ...
  /** @deprecated Use `worldTile` instead. This alias will be removed in the next major version. */
  readonly "WorldTile": __TablesBase["worldTile"];
};
